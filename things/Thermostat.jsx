  ...
  renderContent() {
    ...
    return (
      <Card expanded={this.state.expanded} onExpandChange={this.handleExpandChange}>
        <CardHeader
          title="Thermostat"
          subtitle={"Heater: " + this.props.thing.properties.state}
          actAsExpander={true}
          showExpandableButton={true}
        />
        <CardText><h2 style={{marginTop: -20, marginBottom: -20}}>{event ? event.event.message : '-'}<i className="wi wi-celsius"></i></h2></CardText>
        <CardText expandable={true}>
          ...
          <h4>Heater: {thing.properties.state}</h4>
          ...
          <TextField
            hintText="Threshold"
            data-key="threshold"
            floatingLabelText="Temperature threshold"
          ...
          <TextField
            ...
            data-key="day"
            defaultValue={thing.properties.growfile.temperature.ideal}
...
export default ThermostatContainer = createContainer(({ thing }) => {
