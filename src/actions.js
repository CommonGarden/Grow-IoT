...
import {setInterval, parse} from 'later'
 ...
 */
  ...
  */
  ...
  startAction (action) {
    ...
    if (!isUndefined(meta.schedule)) {
      var schedule = parse.text(meta.schedule);
      var scheduledAction = setInterval(function() {this.callAction(action);}, schedule);
