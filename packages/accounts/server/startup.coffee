...
Meteor.startup(->
  ...
  process.env.MAIL_URL = "noReply@commongarden.org"


  #### EXTRA STUFF: we currently aren't using 3rd party sign-in.
  #### See https://themeteorchef.com/recipes/roll-your-own-authentication/ for more info
  #### on configuring 3rd party authentication.
