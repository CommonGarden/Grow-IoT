...
class Grow extends Thing {
  ...
  parsePhases(phases) {
    _.each(phases, (list, iteratee)=> {
      console.log(list);
      console.log(iteratee);
      // If properties...
      // let scheduledTime = later.parse.text(String(phases[iteratee].start));
      // return later.setTimeout(()=> {
      //   try {
      //     let cycles = phases[iteratee].cycles;
      //     let targets = phases[iteratee].targets;
      ...
      //     if (targets) {
      //       this.set('targets', phases[iteratee].targets);
      //     }

      //     if(phases[iteratee].options) {
      //       this.call(iteratee, phases[iteratee].options);
      //     } else {
      //       console.log(iteratee);
      //       this.call(iteratee);
      //     }
  ...
  // the scheduler component of Grow.js... rename to scheduler?
  parseCycles(cycles) {
