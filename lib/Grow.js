...
// Why are we using meteor-later again?
...
class Grow {
  constructor(config) {
    try {
      ...
      // More thought should be put into how we handle state in case of loss of power, etc.
    ...
    */
    ...
    this.set = (property, value, key) => {
      ...
      // XXX: clean this up. The core of this should be protocol agnostic.
      if (this.ddpclient) {
        this.ddpclient.call(
          'Device.setProperty',
  ...
  // TODO: break these out into seperate files when we add MQTT support.
