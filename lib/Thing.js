...
class Thing extends EventEmitter {
   ...
   * Don't use in production... but do help us get it to the point where we can.
   */
  listen (options) {
  ...
  connect () {
    // TODO call Thing.register and subscribe to Thing.messages
